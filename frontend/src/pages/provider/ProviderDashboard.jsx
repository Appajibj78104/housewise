...
const ProviderDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Try to fetch from API, but provide fallback data if backend is not available
      try {
        ...
        setTodaysBookings([
          {
            ...
            scheduledTime: { start: '10:00 AM', end: '12:00 PM' },
            status: 'confirmed'
          },
          {
            _id: 'mock2',
            service: { title: 'Cooking Service' },
            customer: { name: 'Jane Smith' },
            scheduledTime: { start: '2:00 PM', end: '4:00 PM' },
            status: 'pending'
          }
        ]);
